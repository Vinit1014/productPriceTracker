    ...
    return (
        <div className='w-full max-w-11/12 p-6 mt-6 border rounded-lg bg-white shadow-md'>
            {product ? (
                ...
                <p className="font-bold text-xl mt-4">Price: ₹{product.currentPrice.toFixed(2)}</p>
                ...
                <p className="font-bold text-red-500">No product fetchedsdaaaad. Try to fetch details of any product by entering URL of any product and clicking on "Fetch details"</p>
            )}
        </div>
    );
};
